...
public class MxsParser extends Parser {
	...
	public static final int
		...
		T__52=53, T__53=54, ID=55, STR=56, NUM=57, WS=58, LINE_COMMENT=59;
	public static final int
		RULE_compilationUnit = 0, RULE_defs = 1, RULE_varname = 2, RULE_defvars = 3, 
		RULE_defvar = 4, RULE_typename = 5, RULE_type = 6, RULE_basetype = 7, 
		...
		RULE_expr = 17, RULE_news = 18;
	public static final String[] ruleNames = {
		"compilationUnit", "defs", "varname", "defvars", "defvar", "typename", 
		"type", "basetype", "classname", "defclass", "funcname", "defunc", "params", 
		"param", "block", "stmt", "exprs", "expr", "news"
	};

	private static final String[] _LITERAL_NAMES = {
		null, "';'", "'='", "'['", "']'", "'int'", "'bool'", "'void'", "'string'", 
		"'class'", "'{'", "'('", "')'", "'}'", "','", "'if'", "'0'", "'else'", 
		"'for'", "'while'", "'return'", "'break'", "'continue'", "'new'", "'.'", 
		"'++'", "'--'", "'-'", "'!'", "'~'", "'+'", "'*'", "'/'", "'%'", "'<<'", 
		"'>>'", "'&'", "'^'", "'|'", "'>'", "'<'", "'>='", "'<='", "'=='", "'!='", 
		"'&&'", "'||'", "'?'", "':'", "'NULL'", "'null'", "'TRUE'", "'true'", 
		"'FALSE'", "'false'"
	...
	private static final String[] _SYMBOLIC_NAMES = {
		...
		null, null, null, null, null, null, null, null, null, null, null, null, 
		null, null, null, null, null, null, null, null, null, null, null, null, 
		null, null, null, null, null, null, null, "ID", "STR", "NUM", "WS", "LINE_COMMENT"
	};
	...
	public static class DefsContext extends ParserRuleContext {
		public DefuncContext defunc() {
			return getRuleContext(DefuncContext.class,0);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MxsListener ) ((MxsListener)listener).enterDefs(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MxsListener ) ((MxsListener)listener).exitDefs(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MxsVisitor ) return ((MxsVisitor<? extends T>)visitor).visitDefs(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << T__4) | (1L << T__5) | (1L << T__6) | (1L << T__7) | (1L << T__9) | (1L << T__10) | (1L << T__14) | (1L << T__17) | (1L << T__18) | (1L << T__19) | (1L << T__20) | (1L << T__21) | (1L << T__22) | (1L << T__24) | (1L << T__25) | (1L << T__26) | (1L << T__27) | (1L << T__28) | (1L << T__48) | (1L << T__49) | (1L << T__50) | (1L << T__51) | (1L << T__52) | (1L << T__53) | (1L << ID) | (1L << STR) | (1L << NUM))) != 0)) {
				{
				{
				setState(117);
				stmt();
	...
	public static class StmtContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MxsListener ) ((MxsListener)listener).enterStmt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MxsListener ) ((MxsListener)listener).exitStmt(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MxsVisitor ) return ((MxsVisitor<? extends T>)visitor).visitStmt(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final StmtContext stmt() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				{
				setState(135);
				((StmtContext)_localctx).op = match(T__17);
				setState(136);
				match(T__10);
				setState(138);
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__10) | (1L << T__22) | (1L << T__24) | (1L << T__25) | (1L << T__26) | (1L << T__27) | (1L << T__28) | (1L << T__48) | (1L << T__49) | (1L << T__50) | (1L << T__51) | (1L << T__52) | (1L << T__53) | (1L << ID) | (1L << STR) | (1L << NUM))) != 0)) {
					{
					setState(137);
					expr(0);
					}
			...
			case 4:
				...
				{
				setState(150);
				((StmtContext)_localctx).op = match(T__18);
				setState(151);
				match(T__10);
				setState(153);
				_errHandler.sync(this);
			...
			case 5:
				...
				{
				setState(157);
				((StmtContext)_localctx).op = match(T__19);
				setState(159);
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__10) | (1L << T__22) | (1L << T__24) | (1L << T__25) | (1L << T__26) | (1L << T__27) | (1L << T__28) | (1L << T__48) | (1L << T__49) | (1L << T__50) | (1L << T__51) | (1L << T__52) | (1L << T__53) | (1L << ID) | (1L << STR) | (1L << NUM))) != 0)) {
	...
	public static class ExprContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MxsListener ) ((MxsListener)listener).enterExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MxsListener ) ((MxsListener)listener).exitExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MxsVisitor ) return ((MxsVisitor<? extends T>)visitor).visitExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class NewsContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MxsListener ) ((MxsListener)listener).enterNews(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MxsListener ) ((MxsListener)listener).exitNews(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MxsVisitor ) return ((MxsVisitor<? extends T>)visitor).visitNews(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\26\30\32\34\36 \"$&\2\13\3\2\7\n\3\2\33\34\3\2\35\37\3\2\63\64\3\2\65"+
		"8\4\2\35\35  \3\2!#\3\2$%\3\2).\2\u0164\2+\3\2\2\2\4\63\3\2\2\2\6\65\3"+
		"\2\2\2\b\67\3\2\2\2\n:\3\2\2\2\f@\3\2\2\2\16D\3\2\2\2\20M\3\2\2\2\22O"+
		"\3\2\2\2\24Q\3\2\2\2\26a\3\2\2\2\30c\3\2\2\2\32r\3\2\2\2\34t\3\2\2\2\36"+
		"v\3\2\2\2 \u00ad\3\2\2\2\"\u00af\3\2\2\2$\u00ce\3\2\2\2&\u0134\3\2\2\2"+
		"(*\5\4\3\2)(\3\2\2\2*-\3\2\2\2+)\3\2\2\2+,\3\2\2\2,.\3\2\2\2-+\3\2\2\2"+
		"./\7\2\2\3/\3\3\2\2\2\60\64\5\30\r\2\61\64\5\b\5\2\62\64\5\24\13\2\63"+
		"\60\3\2\2\2\63\61\3\2\2\2\63\62\3\2\2\2\64\5\3\2\2\2\65\66\79\2\2\66\7"+
		"\3\2\2\2\678\5\n\6\289\7\3\2\29\t\3\2\2\2:;\5\16\b\2;>\5\6\4\2<=\7\4\2"+
		"\2=?\5$\23\2><\3\2\2\2>?\3\2\2\2?\13\3\2\2\2@A\79\2\2A\r\3\2\2\2BE\5\20"+
		...
		"\3\2\2\2OP\79\2\2P\23\3\2\2\2QR\7\13\2\2RS\5\22\n\2S\\\7\f\2\2TU\79\2"+
		...
		"_`\7\17\2\2`\25\3\2\2\2ab\79\2\2b\27\3\2\2\2cd\5\16\b\2de\5\26\f\2ef\7"+
		...
		"\u00cf\3\2\2\2\u00bf\u00c0\7\31\2\2\u00c0\u00cf\5&\24\2\u00c1\u00c2\t"+
		"\3\2\2\u00c2\u00cf\5$\23\26\u00c3\u00c4\t\4\2\2\u00c4\u00cf\5$\23\24\u00c5"+
