...
public class ScopeCollector implements ASTVisitor {
    private Scope currentScope;
    private Stack<Scope> scopeStack = new Stack<>();
    private ERROR error;

    public ScopeCollector(Scope topScope, ERROR handle) {
    ...
    public void visit(ClassDeclNode node)
    {
        if(!currentScope.isTop())
            error.addError(node.getLocation(), "class defination should be at top scope");
